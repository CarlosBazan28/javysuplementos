...
const PRODUCT_LIST = [
  ...
  product({ id: "brutal-mass-15lb", nombre: "Brutal Mass 15 lb", precio: 60, categoria: "Ganadores de Peso", marca: "Brutal Mass", presentacion: "15 lb", sabores: ["Chocolate", "Cookies"], objetivos: ["Ganar masa muscular", "Subir calorías"], destacado: true }),
  product({ id: "brutal-mass-7-5lb", nombre: "Brutal Mass 7.5 lb", precio: 33.5, categoria: "Ganadores de Peso", marca: "Brutal Mass", presentacion: "7.5 lb", sabores: ["Chocolate"], objetivos: ["Ganar masa muscular", "Subir calorías"] }),
  product({ id: "nutrex-mass-infusion-12lb", nombre: "Nutrex Mass Infusion 12 lb", precio: 62, categoria: "Ganadores de Peso", marca: "Nutrex", presentacion: "12 lb", sabores: ["Vainilla", "Chocolate"], objetivos: ["Ganar masa muscular", "Subir calorías"], destacado: true }),
  product({ id: "optimum-nutrition-serious-mass-12lb", nombre: "Optimum Nutrition Serious Mass 12 lb", precio: 62, categoria: "Ganadores de Peso", marca: "Optimum Nutrition", presentacion: "12 lb", sabores: ["Chocolate", "Chocolate Peanut Butter", "Vainilla"], objetivos: ["Ganar masa muscular", "Subir calorías"], destacado: true }),
  product({ id: "carnivor-mass-6lb", nombre: "Carnivor Mass 6 lb", precio: 47, categoria: "Ganadores de Peso", marca: "MuscleMeds", presentacion: "6 lb", sabores: ["Chocolate", "Vainilla"], objetivos: ["Ganar masa muscular", "Subir calorías"] }),
  product({ id: "biosport-xtreme-gainer-6lb", nombre: "Biosport Xtreme Gainer 6 lb", precio: 35, categoria: "Ganadores de Peso", marca: "Biosport", presentacion: "6 lb", sabores: ["Vainilla"], objetivos: ["Ganar masa muscular", "Subir calorías"] }),

  product({ id: "mutant-iso-surge-5lb", nombre: "Mutant ISO Surge 5 lb", precio: 74, categoria: "Proteínas ISO", marca: "Mutant", presentacion: "5 lb", sabores: ["Fresa", "Cookies", "Vainilla", "Triple Chocolate"], objetivos: ["Recuperación", "Definición"], destacado: true }),
  product({ id: "biosport-absolute-iso-5lb", nombre: "Biosport Absolute ISO 5 lb", precio: 65, categoria: "Proteínas ISO", marca: "Biosport", presentacion: "5 lb", sabores: ["Cookies", "Vainilla", "Chocolate"], objetivos: ["Recuperación", "Definición"] }),
  product({ id: "nutrex-isofit-protein-5lb", nombre: "Nutrex Isofit Protein 5 lb", precio: 75, categoria: "Proteínas ISO", marca: "Nutrex", presentacion: "5 lb", sabores: ["Fresa", "Cookies", "Vainilla", "Chocolate", "Banana"], objetivos: ["Recuperación", "Definición"], destacado: true, imagen: "img/products/isofit-5lb-nutrex.png" }),
  product({ id: "carnivor-iso-4lb", nombre: "Carnivor ISO 4 lb", precio: 63, categoria: "Proteínas ISO", marca: "MuscleMeds", presentacion: "4 lb", sabores: ["Fresa", "Chocolate", "Chocolate Maní", "Cookies", "Vainilla"], objetivos: ["Recuperación", "Definición"] }),
  product({ id: "nutrex-isofit-protein-2lb", nombre: "Nutrex Isofit Protein 2 lb", precio: 40, categoria: "Proteínas ISO", marca: "Nutrex", presentacion: "2 lb", sabores: ["Chocolate", "Cookies", "Fresa", "Banana", "Vainilla"], objetivos: ["Recuperación", "Definición"], destacado: true, imagen: "img/products/isofit-2lb-nutrex.png" }),
  product({ id: "isomorph-28g-protein", nombre: "Isomorph 28 g Protein", precio: 36, categoria: "Proteínas ISO", marca: "Isomorph", presentacion: "28 g protein", sabores: ["Honey Granola", "Cookies", "Chocolate", "Vainilla", "Fresa"], objetivos: ["Recuperación", "Definición"] }),
  product({ id: "htp-precision-protein", nombre: "HTP Precision Protein", precio: 36, categoria: "Proteínas ISO", marca: "HTP", sabores: ["Chocolate Peanut Butter", "Cookies", "Chocolate", "Honey Granola", "Fresa", "Vainilla"], objetivos: ["Recuperación", "Definición"] }),
  product({ id: "carnivor-iso-2lb", nombre: "Carnivor ISO 2 lb", precio: 38.5, categoria: "Proteínas ISO", marca: "MuscleMeds", presentacion: "2 lb", sabores: ["Chocolate", "Chocolate Peanut Butter", "Vainilla", "Cookies"], objetivos: ["Recuperación", "Definición"] }),
  product({ id: "raw-grass-fed-isolate-2lb", nombre: "RAW Grass Fed Isolate Protein 2 lb", precio: 45, categoria: "Proteínas ISO", marca: "RAW Nutrition", presentacion: "2 lb", sabores: ["Vainilla", "Chocolate"], objetivos: ["Recuperación", "Definición"] }),

  product({ id: "mutant-whey-protein-5lb", nombre: "Mutant Whey Protein 5 lb", precio: 50, categoria: "Proteínas Whey", marca: "Mutant", presentacion: "5 lb", sabores: ["Vainilla", "Brownie", "Triple Chocolate", "Cookies", "Fresa"], objetivos: ["Recuperación", "Masa muscular"] }),
  product({ id: "optimum-nutrition-gold-standard-whey-5lb", nombre: "Optimum Nutrition Gold Standard 100% Whey 5 lb", precio: 75, categoria: "Proteínas Whey", marca: "Optimum Nutrition", presentacion: "5 lb", sabores: ["Chocolate", "Vainilla", "Cookies", "Fresas con crema"], objetivos: ["Recuperación", "Masa muscular"], destacado: true }),
  product({ id: "muscletech-nitro-tech-whey-gold-5lb", nombre: "MuscleTech Nitro-Tech Whey Gold 5 lb", precio: 72, categoria: "Proteínas Whey", marca: "MuscleTech", presentacion: "5 lb", sabores: ["Chocolate", "Vainilla", "Chocolate Peanut Butter"], objetivos: ["Recuperación", "Masa muscular"] }),
  product({ id: "xtreme-whey-5lb", nombre: "Xtreme Whey 5 lb", precio: 55, categoria: "Proteínas Whey", marca: "Xtreme", presentacion: "5 lb", sabores: ["Chocolate", "Vainilla", "Cookies"], objetivos: ["Recuperación", "Masa muscular"] }),
  product({ id: "prosupps-whey-premium-5lb", nombre: "ProSupps Whey Premium Protein 5 lb", precio: 58, categoria: "Proteínas Whey", marca: "ProSupps", presentacion: "5 lb", sabores: ["Vainilla"], objetivos: ["Recuperación", "Masa muscular"] }),
  product({ id: "nutrabol-c4-whey-5lb", nombre: "Nutrabol C4 Whey Protein 5 lb", precio: 71, categoria: "Proteínas Whey", marca: "Nutrabol", presentacion: "5 lb", sabores: ["Chocolate Peanut Butter", "Vainilla"], objetivos: ["Recuperación", "Masa muscular"] }),
  product({ id: "nutricost-protein-1-5lb", nombre: "Nutricost Protein 1.5 lb", precio: 24, categoria: "Proteínas Whey", marca: "Nutricost", presentacion: "1.5 lb", sabores: ["Vainilla", "Chocolate"], objetivos: ["Recuperación", "Masa muscular"] }),
  product({ id: "muscletech-nitro-tech-whey-gold-2lb", nombre: "MuscleTech Nitro-Tech Whey Gold 2 lb", precio: 40, categoria: "Proteínas Whey", marca: "MuscleTech", presentacion: "2 lb", sabores: ["Cookies", "Vainilla"], objetivos: ["Recuperación", "Masa muscular"] }),
  product({ id: "nutrex-100-whey-protein", nombre: "Nutrex 100% Whey Protein", precio: 35, categoria: "Proteínas Whey", marca: "Nutrex", sabores: ["Chocolate", "Vainilla", "Cookies"], objetivos: ["Recuperación", "Masa muscular"], imagen: "img/products/whey-nutrex-2lb.png" }),
  product({ id: "nutrabol-c4-whey-2lb", nombre: "Nutrabol C4 Whey Protein 2 lb", precio: 38, categoria: "Proteínas Whey", marca: "Nutrabol", presentacion: "2 lb", sabores: ["Chocolate Hersheys", "Chocolate Peanut Butter", "Vainilla"], objetivos: ["Recuperación", "Masa muscular"] }),
  ...
  product({ id: "nutrex-creatine-flavored-60-serv", nombre: "Nutrex Creatine 60 servidas saborizada", precio: 18, categoria: "Creatinas", marca: "Nutrex", presentacion: "60 servidas", sabores: ["Fruit Punch", "Fresa Sandía"], objetivos: ["Fuerza", "Rendimiento"], imagen: "img/products/creatine-fruit-punch-60srv.png" }),
  product({ id: "nutrex-creatine-60-serv", nombre: "Nutrex Creatine Monohydrate 60 servidas", precio: 12.5, categoria: "Creatinas", marca: "Nutrex", presentacion: "60 servidas", objetivos: ["Fuerza", "Rendimiento"], destacado: true, imagen: "img/products/creatine-nutrex-60srv.png" }),
  product({ id: "nutrex-creatine-200-serv", nombre: "Nutrex Creatine Monohydrate 200 servidas", precio: 33.5, categoria: "Creatinas", marca: "Nutrex", presentacion: "200 servidas", objetivos: ["Fuerza", "Rendimiento"], destacado: true }),
  ...
  product({ id: "mesomorph-pre-workout", nombre: "Mesomorph Pre-Workout", precio: 26.5, categoria: "Pre Entrenos", marca: "APS Nutrition", sabores: ["Varios sabores"], objetivos: ["Energía", "Enfoque", "Rendimiento"], destacado: true }),
  ...
  product({ id: "nutrex-lipo-6-black-60-caps", nombre: "Nutrex Lipo-6 Black 60 cápsulas", precio: 20, categoria: "Quemadores", marca: "Nutrex", presentacion: "60 cápsulas", objetivos: ["Definición", "Energía"], destacado: true, imagen: "img/products/lipo-6-black-60caps.png" }),
