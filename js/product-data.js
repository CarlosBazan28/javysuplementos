...
const PRODUCT_LIST = [
  ...
  product({ id: "brutal-mass-15lb", nombre: "Brutal Mass 15 lb", precio: 60, categoria: "Ganadores de Peso", marca: "Brutal Mass", presentacion: "15 lb", sabores: ["Chocolate", "Cookies"], objetivos: ["Ganar masa muscular", "Subir calorías"], destacado: true, imagen: "img/products/brutal-mass-15lb.webp" }),
  ...
  product({ id: "optimum-nutrition-gold-standard-whey-5lb", nombre: "Optimum Nutrition Gold Standard 100% Whey 5 lb", precio: 75, categoria: "Proteínas Whey", marca: "Optimum Nutrition", presentacion: "5 lb", sabores: ["Chocolate", "Vainilla", "Cookies", "Fresas con crema"], objetivos: ["Recuperación", "Masa muscular"], destacado: true, imagen: "img/products/optimum-nutrition-gold-standard-whey-5lb.webp" }),
