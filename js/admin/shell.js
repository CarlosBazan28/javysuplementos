/* ============================================================================
   ...
   ============================================================================ */
import { state } from "./state.js?v=adm-75df4cc8";
import { NAV } from "./config.js?v=adm-75df4cc8";
import { $, $$, esc, ico } from "./helpers.js?v=adm-75df4cc8";
import { showViewError } from "./view.js?v=adm-75df4cc8";
import { renderDashboard } from "./sections/dashboard.js?v=adm-75df4cc8";
import { renderProducts } from "./sections/products.js?v=adm-75df4cc8";
import { renderHome } from "./sections/home.js?v=adm-75df4cc8";
import { renderCategories } from "./sections/categories.js?v=adm-75df4cc8";
import { renderCombos } from "./sections/combos.js?v=adm-75df4cc8";
import { renderAccess } from "./sections/access.js?v=adm-75df4cc8";
import { renderSettings } from "./sections/settings.js?v=adm-75df4cc8";
import { openProductDrawer } from "./drawers/product-drawer.js?v=adm-75df4cc8";
import { canWrite } from "./permissions.js?v=adm-75df4cc8";
import { renderUserChip } from "./user-chip.js?v=adm-75df4cc8";
