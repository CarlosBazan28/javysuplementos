/* ============================================================================
   ...
   ============================================================================ */
import { state, catById, families, typesOf } from "../state.js?v=adm-e26cac9b";
import { PLACEHOLDER, HOME_MAX, GOAL_SUGGESTIONS } from "../config.js?v=adm-e26cac9b";
import { $, esc, ico } from "../helpers.js?v=adm-e26cac9b";
import { field, affix, switchRow, switchMarkup, chipTag, bindChips, confirmModal, toast } from "../ui.js?v=adm-e26cac9b";
import { requestRerender } from "../shell.js?v=adm-e26cac9b";
