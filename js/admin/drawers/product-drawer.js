/* ============================================================================
   ...
   ============================================================================ */
import { state, catById, families, typesOf } from "../state.js?v=adm-3313decc";
import { PLACEHOLDER, HOME_MAX, GOAL_SUGGESTIONS } from "../config.js?v=adm-3313decc";
import { $, esc, ico } from "../helpers.js?v=adm-3313decc";
import { field, affix, switchRow, switchMarkup, chipTag, bindChips, confirmModal, toast } from "../ui.js?v=adm-3313decc";
import { requestRerender } from "../shell.js?v=adm-3313decc";
