/* ============================================================================
   ...
   ============================================================================ */
import { state, families, typesOf, catById } from "../state.js?v=adm-48e30e27";
import { $, esc, ico, imgTag, peso, hasOffer, isAvailable, isMissingImage, stockTone, wireImageFallbacks } from "../helpers.js?v=adm-48e30e27";
import { setView } from "../view.js?v=adm-48e30e27";
import { bindEditClicks } from "../shell.js?v=adm-48e30e27";
import { confirmModal, toast } from "../ui.js?v=adm-48e30e27";
