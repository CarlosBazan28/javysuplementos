/* ============================================================================
   ...
   ============================================================================ */
import { state, families, typesOf, catById } from "../state.js?v=adm-1c6bf4a6";
import { $, esc, ico, imgTag, peso, hasOffer, isAvailable, isMissingImage, stockTone, wireImageFallbacks } from "../helpers.js?v=adm-1c6bf4a6";
import { setView } from "../view.js?v=adm-1c6bf4a6";
import { bindEditClicks } from "../shell.js?v=adm-1c6bf4a6";
import { confirmModal, toast } from "../ui.js?v=adm-1c6bf4a6";
