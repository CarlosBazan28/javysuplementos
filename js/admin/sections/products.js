/* ============================================================================
   ...
   ============================================================================ */
import { state, families, typesOf, catById } from "../state.js?v=adm-217c243e";
import { $, esc, ico, imgTag, peso, hasOffer, isAvailable, isMissingImage, stockTone, wireImageFallbacks } from "../helpers.js?v=adm-217c243e";
import { setView } from "../view.js?v=adm-217c243e";
import { bindEditClicks } from "../shell.js?v=adm-217c243e";
import { confirmModal, toast } from "../ui.js?v=adm-217c243e";
