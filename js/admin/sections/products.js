/* ============================================================================
   ...
   ============================================================================ */
import { state, families, typesOf, catById } from "../state.js?v=adm-9250919f";
import { $, esc, ico, imgTag, peso, hasOffer, isAvailable, isMissingImage, stockTone, wireImageFallbacks } from "../helpers.js?v=adm-9250919f";
import { setView } from "../view.js?v=adm-9250919f";
import { bindEditClicks } from "../shell.js?v=adm-9250919f";
import { confirmModal, toast } from "../ui.js?v=adm-9250919f";
