...
import { $, $$, esc, ico, initials } from "../helpers.js?v=adm-9973a1e9";
import { setView } from "../view.js?v=adm-9973a1e9";
import { switchMarkup, toast, confirmModal, formModal, ensureMenuListeners, closeAllMenus } from "../ui.js?v=adm-9973a1e9";
import { ROLES, roleLabel, canManageUsers } from "../permissions.js?v=adm-9973a1e9";
