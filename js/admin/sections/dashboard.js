...
import { STALE_DAYS, HOME_MAX, HOME_MIN } from "../config.js?v=adm-217c243e";
import { $, esc, ico, imgTag, peso, isAvailable, isMissingImage, hasOffer, discountPct, daysSince, agoLabel } from "../helpers.js?v=adm-217c243e";
import { setView } from "../view.js?v=adm-217c243e";
import { go, bindEditClicks } from "../shell.js?v=adm-217c243e";
