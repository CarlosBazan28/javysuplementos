/* ============================================================================
   ...
   ============================================================================ */
import { state, catById } from "../state.js?v=adm-e4c575f0";
import { esc, ico, peso, hasOffer, discountPct, isAvailable, agoLabel } from "../helpers.js?v=adm-e4c575f0";
import { paint } from "../view.js?v=adm-e4c575f0";
import { toast } from "../ui.js?v=adm-e4c575f0";
import { buildTable, printReport, slugify, buildReportPDF, saveOrShare } from "../export.js?v=adm-e4c575f0";
