/* ============================================================================
   ...
   ============================================================================ */
import { state, catById } from "../state.js?v=adm-9973a1e9";
import { esc, ico, peso, hasOffer, discountPct, isAvailable, agoLabel } from "../helpers.js?v=adm-9973a1e9";
import { paint } from "../view.js?v=adm-9973a1e9";
import { toast } from "../ui.js?v=adm-9973a1e9";
import { buildTable, printReport, slugify, buildReportPDF, saveOrShare } from "../export.js?v=adm-9973a1e9";
